...
export default class DashboardView extends React.Component<AllProps, any> {
    ...
    public componentWillMount() {
        if (this.props.account && (this.props.portfolio.portfolioExist || localStorage.getItem(this.props.account))) {
            this.props.fetchCommitment(this.props.account);
        }
    }

    public componentWillReceiveProps(nextProps: Props) {
        if (this.props.account !== nextProps.account && localStorage.getItem(nextProps.account)) {
